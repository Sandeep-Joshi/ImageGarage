...
namespace ImageSharingWebRole.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        //[HttpPost]
        //public ActionResult Register(UserView UserInfo)  // takes the bind with view model here and then manually bind with entity model
        //{
        //    CheckAda();
        ...
        //    //User User = db.Users.SingleOrDefault(u => u.
        //    if (User != null)
        //    {
        ...
        //    else
        //    {
        //        ViewBag.Message = "No such user reistered!";
        //        return View("Login");
        //    }
        //}
        ...
        //
        // GET: /Account/Login
        //Added to bypass FilterConfig default setting  m`
        [AllowAnonymous]
        [RequireHttps]
        public ActionResult Login(string returnUrl)
        {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    user.addQueue();  // should make this implicit by overriding some method later on
